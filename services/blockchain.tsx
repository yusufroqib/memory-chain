...
import p2eAbi from '@/artifacts/contracts/MemoryChain.sol/MemoryChain.json'
...
const getEthereumContracts = async () => {
  ...
  if (accounts?.length > 0) {
    ...
    const contracts = new ethers.Contract(address.memoryChainContract, p2eAbi.abi, signer)
